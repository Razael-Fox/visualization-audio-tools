...
import { Button, Container, Group, Text, Title, ThemeIcon } from "@mantine/core";
...
export default function GlobalError({
  ...
  return (
    <Container size="sm" py="xl" className="min-h-[70vh] flex flex-col items-center justify-center text-center">
      <ThemeIcon size={80} radius="100%" color="red" variant="light" className="mb-6">
